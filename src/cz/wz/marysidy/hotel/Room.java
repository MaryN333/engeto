...
public class Room {
    ...
    private double priceKcPerNight;
    private List<Booking> bookings = new ArrayList<>();


    public Room(int roomNumber, int bedsNumber, boolean isBalcony, boolean isSeaView, double price) {
    ...
    public double getPriceKcPerNight() {
        return priceKcPerNight;
    }

    public void setPriceKcPerNight(double priceKcPerNight) {
